		...
		<div className="space-y-6">
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						{data
							? `Showing ${data.data.length} of ${data.pagination.total.toLocaleString()} proposals`
							: "Loading..."}
					</CardDescription>
				</CardHeader>
				<CardContent>
										...
										<TableCell>
											<div className="text-sm">
												...
												proposal.voting_end_time ? (
													<>
														{formatTimeAgo(proposal.voting_start_time)} -{" "}
														{formatTimeAgo(proposal.voting_end_time)}
													</>
												) : (
