 ...
 * All icons are decorative and use aria-hidden for accessibility
 */
...
export const DocumentIcon = ({ className = '' }: IconProps) => (
	<svg viewBox="0 0 24 24" className={className} xmlns="http://www.w3.org/2000/svg" fill="none" aria-hidden="true">
